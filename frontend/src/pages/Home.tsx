...
export default function Home() {
  ...
  "
      ...
      "
        >
          ...
          <p className="text-slate-300">
            Monitor your rooms, connected
            devices and receive instant
    ...
    "
      >
        Monitor energy usage, detect abnormal
        behavior and receive instant alerts
      ...
      "
        ...
        "
          >
            Track room activity and energy
      ...
      "
        ...
        "
          >
            Identify unusual behavior before it
